export enum AwCliErrorType {
  ...
  ADMIN_ENABLE_TOOL_NO_DISABLED_TOOLS = 'ADMIN_ENABLE_TOOL_NO_DISABLED_TOOLS',
  ADMIN_ENABLE_TOOL_CANCELLED = 'ADMIN_ENABLE_TOOL_CANCELLED',
  ADMIN_DISABLE_TOOL_NO_ENABLED_TOOLS = 'ADMIN_DISABLE_TOOL_NO_ENABLED_TOOLS',
  ADMIN_DISABLE_TOOL_CANCELLED = 'ADMIN_DISABLE_TOOL_CANCELLED',
  ADMIN_ENABLE_TOOL_POLICY_NO_DISABLED_TOOLS = 'ADMIN_ENABLE_TOOL_POLICY_NO_DISABLED_TOOLS',
  ADMIN_ENABLE_TOOL_POLICY_NO_TOOLS_FOUND = 'ADMIN_ENABLE_TOOL_POLICY_NO_TOOLS_FOUND',
  ADMIN_ENABLE_TOOL_POLICY_CANCELLED = 'ADMIN_ENABLE_TOOL_POLICY_CANCELLED',
  ADMIN_DISABLE_TOOL_POLICY_NO_ENABLED_TOOLS = 'ADMIN_DISABLE_TOOL_POLICY_NO_ENABLED_TOOLS',
  ADMIN_DISABLE_TOOL_POLICY_CANCELLED = 'ADMIN_DISABLE_TOOL_POLICY_CANCELLED',
  ADMIN_DISABLE_TOOL_POLICY_NO_TOOLS_FOUND = 'ADMIN_DISABLE_TOOL_POLICY_NO_TOOLS_FOUND',
  ADMIN_PERMIT_TOOL_FOR_DELEGATEE_NO_TOOLS_FOUND = 'ADMIN_PERMIT_TOOL_FOR_DELEGATEE_NO_TOOLS_FOUND',
  ADMIN_PERMIT_TOOL_FOR_DELEGATEE_CANCELLED = 'ADMIN_PERMIT_TOOL_FOR_DELEGATEE_CANCELLED',
  ...
  ADMIN_PERMIT_TOOL_FOR_DELEGATEE_NO_UNPERMITTED_TOOLS = 'ADMIN_PERMIT_TOOL_FOR_DELEGATEE_NO_UNPERMITTED_TOOLS',
  ADMIN_UNPERMIT_TOOL_FOR_DELEGATEE_NO_PERMITTED_TOOLS = 'ADMIN_UNPERMIT_TOOL_FOR_DELEGATEE_NO_PERMITTED_TOOLS',
  ADMIN_UNPERMIT_TOOL_FOR_DELEGATEE_CANCELLED = 'ADMIN_UNPERMIT_TOOL_FOR_DELEGATEE_CANCELLED',
  ADMIN_ENABLE_TOOL_POLICY_NO_DELEGATEES = 'ADMIN_ENABLE_TOOL_POLICY_NO_DELEGATEES',
  ADMIN_SET_TOOL_POLICY_PARAMETER_CANCELLED = 'ADMIN_SET_TOOL_POLICY_PARAMETER_CANCELLED',
  ADMIN_SET_TOOL_POLICY_PARAMETER_NO_DELEGATEES = 'ADMIN_SET_TOOL_POLICY_PARAMETER_NO_DELEGATEES',
  ADMIN_SET_TOOL_POLICY_PARAMETER_FAILED = 'ADMIN_SET_TOOL_POLICY_PARAMETER_FAILED',
  ADMIN_PERMIT_TOOL_FOR_DELEGATEE_NO_DELEGATEES_FOUND = 'ADMIN_PERMIT_TOOL_FOR_DELEGATEE_NO_DELEGATEES_FOUND',
